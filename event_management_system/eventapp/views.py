...
#     subject = ' JNTU Event informatoin'
#     message = 'This is your event information'
#     from_email = 'girinetha8@gmail.com'
#     recipient_list = ['yadagirimuda0@gmail.com']
...
#     subject = 'JNTU Event informatoin'
#     text_content = 'This is your event information'
...
#     # msg.send(auth_user=email_user, auth_password=email_password)
#     msg.send()
    
#     return render(request, "sendemail.html", {'msg': 'HTML email sent successfully.'})
...
def sendemail(request):
    if request.method=='POST':
        ...
        mail=send_mail(
            'test email',
            f'hi there {name} \n thank yor for contacting,this is msg: \n {msg}',
            settings.EMAIL_HOST_USER,
            [sender_email]
        )
        mail.fail.silently=True
        mail.send()
